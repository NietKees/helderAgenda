...
<div class=" flex justify-center pt-12">
	...
	<div class="flex flex-col py-10 items-center justify-between">
		<div class="flex flex-col gap-10 items-center">
			...
			<form method="POST" action="?/signup" class="flex flex-col gap-4">
				...
				<div class="flex justify-center">
					<button class="bg-accent rounded-md text-white px-2 py-1 hover:cursor-pointer">sign up</button>
				</div>
			</form>
			<a href="../login" class="underline text-accent italic ">log in</a>
		</div>
